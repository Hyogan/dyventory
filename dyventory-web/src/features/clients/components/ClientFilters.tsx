  ...
  return (
    <div className="card p-4 space-y-3">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        >
          <option value="">{t("clients.filters.all_types")}</option>
        ...
        <select
          ...
          className="input-select h-9 text-sm flex-1 min-w-[140px]"
          aria-label={t("common.status")}
        >
          <option value="">{t("common.all")}</option>
          <option value="1">{t("clients.filters.active_only")}</option>
