    ...
    <table>
        <thead>
            <tr>
                ...
                <th class="num">Revenue TTC</th>
                <th class="num">Revenue HT</th>
                <th class="num">TVA</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="num">{{ number_format($row['revenue_ttc'], 2) }}</td>
                <td class="num">{{ number_format($row['revenue_ht'], 2) }}</td>
                <td class="num">{{ number_format($row['total_tva'], 2) }}</td>
                <td class="num">{{ number_format($row['total_discount'], 2) }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
