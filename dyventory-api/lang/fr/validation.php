...
return [
    ...
    'extensions'           => 'Le champ :attribute doit avoir l\'une des extensions : :values.',
    ...
    'custom' => [
        ...
        'quantity' => [
            'min' => 'La quantité doit être supérieure à zéro.',
        ],
        'attributes' => [
            'array' => 'Les attributs du produit doivent être un objet JSON valide.',
        ],
        'field_schema' => [
            'array' => 'Le schéma de champs doit être un tableau JSON valide.',
        ],
    ],
    ...
    'attributes' => [
        ...
        'sku'             => 'référence SKU',
        'price_buy_ht'    => 'prix d\'achat',
        'price_sell_ttc'  => 'prix de vente',
        'category_id'     => 'catégorie',
        'vat_rate_id'     => 'taux de TVA',
        'unit_of_measure' => 'unité de mesure',
        'current_quantity' => 'quantité actuelle',
        'field_schema'    => 'schéma de champs',
